...
Не применяй форматирований текста и других символов (*, _, #, etc.)
...
6. Задание должно соответствовать примеру по форматированию и стилю речи: "🎯 Задание на день — Уровень F 👶
Цель: Сила + Дисциплина
Название: «Начало пути»

🔹 Разминка (5–7 мин)
• Прыжки на месте — 2 минуты
• Растяжка шеи и плеч — 1 минута
• Приседания — 2×20
...
(отдых между подходами 60–90 сек)
 1. Отжимания от пола:
→ 4×максимум (ориентир — 10–20 раз)
 2. Приседания с собственным весом:
→ 3×20
 3. Планка:
→ 3 подхода по 45 секунд
 4. Контроль дыхания:
→ 10 глубоких вдохов и выдохов с ровной осанкой
(дыхание через нос, выдох — через рот)

⸻

🔹 Финиш: ментальный чек
Закрой глаза на 1 минуту, выровняй дыхание и задай себе вопрос:
“Если бы я не мог сдаться — что бы я сделал?”
...
“Первый день никогда не должен быть идеальным — он должен быть настоящим.”

⸻

🔁 Отчёт:
Фото или видео выполнения + комментарий
#prime_lennart_задание1"

В задании всегда продумывй как его можно отправить на проверку фото демострация или видео до 30 секунд
