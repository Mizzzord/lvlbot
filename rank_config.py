...
RANK_EXPERIENCE_REQUIREMENTS = {
    ...
    Rank.E: 1000,      # 500 опыта для ранга E
    Rank.D: 3000,     # 1500 опыта для ранга D
    Rank.C: 6000,     # 3000 опыта для ранга C
    Rank.B: 15000,     # 5000 опыта для ранга B
    Rank.A: 40000,     # 7500 опыта для ранга A
    Rank.S: 80000,    # 10000 опыта для ранга S
    Rank.S_PLUS: 150000  # 15000 опыта для ранга S+
}
